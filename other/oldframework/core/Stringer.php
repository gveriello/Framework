...
class Stringer
{
    ...
    public function after_last ($character)
    {
    ...
    public function before_last ($character)
    {
        return substr($this->value, 0, $this->strrevpos($this->value, $character));
    }

    public function between ($_start, $_stop)
    {
        $string = " ".$this->value;
    ...
    public function between_last ($character, $that)
    {
